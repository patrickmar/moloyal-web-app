                ...
                <div>
                  <a href="#" className="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                    <div className="flex-shrink-0">
                      <Image width={0} height={0} sizes="100vw" className="w-11 h-11 rounded-full" src="/imgs/profiles/img1.jpg" alt="avatar" />
                  ...
                  <a href="#" className="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                    <div className="flex-shrink-0">
                      <Image width={0} height={0} sizes="100vw" className="w-11 h-11 rounded-full" src="/imgs/profiles/img1.jpg" alt="Jese avatar" />
